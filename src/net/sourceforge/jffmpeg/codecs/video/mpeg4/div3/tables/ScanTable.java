...
public class ScanTable {
    public final static int[] getIntraVScanTable() {
        return permutedVScanTable;
    }

    public final static int[] getIntraHScanTable() {
        return permutedHScanTable;
    }

    public final static int[] getIntraScanTable() {
        return permutedScanTable;
    }

    public final static int[] getInterScanTable() {
        return permutedScanTable;
    }
...
//            block_permute_op[ y ] = y;
    ...
    /** zipzag_direct */
    private static int[] scanTable = new int[] {
    0, 1, 8, 16, 9, 2, 3, 10,
    ...
    private static int[] permutedScanTable = null;
    private static int[] permutedHScanTable = null;
    private static int[] permutedVScanTable = null;

    static {
        permutedScanTable = new int[ scanTable.length ];
	for ( int i = 0; i < scanTable.length; i++ ) {
	    permutedScanTable[i] = simple_mmx_permutation[ scanTable[i] ];
        }
