...
import javax.media.Buffer;				//JMF buffer
public class H264Writer{
		...
		public H264Writer(String fileName,int width,int height) throws Exception{
			this.width = width;
			this.height = height;
			frameP = new long[3];
			position = new long[3];
			...
			frameCount = 0;
			System.out.println("Creating outputFile "+fileName);
		...
		//Functions 
		public void write_frame(Buffer buffer) throws Exception{
		...
		void write_buffer(Buffer buffer) throws Exception
		{
			Object dataO = buffer.getData();
			//System.out.println(dataO.getClass().toString());
			//byte [] data = (byte[]) buffer.getData();
			int dataLen = buffer.getLength();
			System.out.println("Len "+dataLen);
			//videoFile.write(data, buffer.getOffset(), dataLen);
		}
	...
	public static void main(String[] args)
		{
			...
			//MJPEG valmistelu
			MpngWriter videoksi(argv[2],videon_leveys,videon_korkeus,3, 99);
